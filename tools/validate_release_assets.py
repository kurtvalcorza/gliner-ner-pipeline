...
CODE_MARKERS = (
    ...
    'from gliner_ner_pipeline import ENCODER_KEY, ENCODER_MODEL_ID, ENCODER_REVISION, MODEL_ID, MODEL'
    '_KEY, MODEL_REVISION, GLiNERPipeline, entity_f1, stage_missing_encoder_files, stage_missing_file'
    's, verify_encoder_snapshot, verify_snapshot',
    ...
    "ceilings = {'MAX_TEXT_CHARS': MAX_TEXT_CHARS, 'MAX_LABELS': MAX_LABELS, 'library_word_limit': 38"
    "4, 'DEFAULT_THRESHOLD': DEFAULT_THRESHOLD}",
...
MARKDOWN_MARKERS = (
    ...
    '`ENCODER_MODEL_ID` at `ENCODER_REVISION`',
    '`MAX_TEXT_CHARS`',
    '`MAX_LABELS`',
